...
void GameMode2D::RenderUIObjects() const
{
	...
	g_theApp->m_textFont->AddVertsForTextInBox2D( textVerts, textbox1, cellHeight, "Mode (F6/F7 for prev/next): SkeletalPlayground (2D)", textColor_darkRed, 0.75f, Vec2( 0.0f, 1.0f ), TextDrawMode::SHRINK_TO_FIT );

	// Hotkeys
	g_theApp->m_textFont->AddVertsForTextInBox2D( textVerts, textbox1, cellHeight, "Hotkey toggles (F1: pos/angle info | F3: debugTargetPos + IJKL | F5: debugGrass)", textColor_darkRed, 0.75f, Vec2( 0.0f, 0.95f ), TextDrawMode::SHRINK_TO_FIT );
	...
	g_theApp->m_textFont->AddVertsForTextInBox2D( textVerts, textbox1, cellHeight, timeText, textColor_darkRed, 0.75f, Vec2( 0.98f, 1.0f ), TextDrawMode::SHRINK_TO_FIT );
...
//	g_theApp->m_textFont->AddVertsForTextInBox2D( textVerts, textbox1, cellHeight, cursorPosText, textColor_darkRed, 0.75f, Vec2( 0.0f, 0.95f ), TextDrawMode::SHRINK_TO_FIT );
	...
	g_theApp->m_textFont->AddVertsForTextInBox2D( textVerts, textbox1, cellHeight, targetPosText, textColor_darkRed, 0.75f, Vec2( 0.0f, 0.90f ), TextDrawMode::SHRINK_TO_FIT );
