...
//----------------------------------------------------------------------------------------------------------------------
GameMode_FABRIK_3D::GameMode_FABRIK_3D()
{
}
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::Startup()
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::Update( float deltaSeconds )
{	
	// Update core systems
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::Render() const
{
	RenderWorldObjects();
	RenderUIObjects();
}
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::Shutdown()
{
}


//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::UpdateDebugKeys()
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::UpdateGameMode3DCamera()
{
	//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::RenderWorldObjects() const
{
	//----------------------------------------------------------------------------------------------------------------------
	// Begin World Camera
	//----------------------------------------------------------------------------------------------------------------------
	...
	g_theApp->m_textFont->AddVertsForText3D( textVerts, textOrigin, iBasis, jBasis, 25.0f, "FABRIK 3D!", Rgba8::GREEN );
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::RenderUIObjects() const
{
	//----------------------------------------------------------------------------------------------------------------------
	// Begin UI Camera
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::AddVertsForCompass( std::vector<Vertex_PCU>&compassVerts, Vec3 startPosition, float axisLength, float axisThickness ) const
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::UpdateTargetInput( float deltaSeconds )
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::UpdateCreature( float deltaSeconds )
{
	// Debug single step
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::RenderCreature( std::vector<Vertex_PCU>& verts, 
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::InitializeCreatures()
{
	//----------------------------------------------------------------------------------------------------------------------
	// Creature
	//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::SetChainConstraints()
{	
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::UpdateCameraAndCreatureInput( float deltaSeconds )
{
...
//----------------------------------------------------------------------------------------------------------------------
void GameMode_FABRIK_3D::UpdatePoleVector()
{
