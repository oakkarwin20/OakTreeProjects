...
Rgba8 const Rgba8::DARK_RED				= Rgba8( 180,   0,   0, 255 );
Rgba8 const Rgba8::DARKER_RED			= Rgba8( 139,   0,   0, 255 );
Rgba8 const Rgba8::LIGHTGREEN			= Rgba8( 100, 255,	 0, 255 );
...
Rgba8 const Rgba8::DARK_ORANGE			= Rgba8( 125,  50,   0, 255 );
...
Rgba8 const Rgba8::DARK_BROWN			= Rgba8(  64,  25,   0, 255	);
...
Rgba8 const Rgba8::DARK_PINK			= Rgba8( 255,  20, 150, 255 );
...
//----------------------------------------------------------------------------------------------------------------------
Rgba8 Rgba8::operator*( float scalar ) const
{
	Rgba8 newColor	= Rgba8( r, g, b, a );
	newColor.r		= newColor.r * scalar;
	newColor.g		= newColor.g * scalar;
	newColor.b		= newColor.b * scalar;
	return newColor;
}

//----------------------------------------------------------------------------------------------------------------------
void Rgba8::operator*=( float scalar )
{
	r = r * scalar;
	g = g * scalar;
	b = b * scalar;
