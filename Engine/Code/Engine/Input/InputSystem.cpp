...
void InputSystem::BeginFrame()
{
	...
	// Save clientRect data for computing normalizedCursorPos later
	m_mouseState.m_clientBounds = Vec2( float(clientRect.right), float(clientRect.bottom) );
...
//----------------------------------------------------------------------------------------------------------------------
// Garbage function????
// Refer to Windows::GetCursorNormalizedPosition instead
Vec2 InputSystem::GetCursorNormalizedPosition() const
{
	Vec2 normalizedCursorClientPosition = GetCursorClientPosition();
// 	Vec2 const& clientBounds			= m_mouseState.m_clientBounds;
// 	normalizedCursorClientPosition.x	= RangeMapClamped( normalizedCursorClientPosition.x, 0.0f, clientBounds.x, 0.0f, 1.0f );
// 	normalizedCursorClientPosition.y	= RangeMapClamped( normalizedCursorClientPosition.y, 0.0f, clientBounds.y, 0.0f, 1.0f );
