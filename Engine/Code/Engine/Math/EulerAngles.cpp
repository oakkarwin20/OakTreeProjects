...
//----------------------------------------------------------------------------------------------------------------------
EulerAngles EulerAngles::GetAsEuler_XFwd_YLeft_ZUp( Quaternion const& quat )
{
	...
	yNorth		 = quat * yNorth;
	zSky		 = quat * zSky;
	EulerAngles rotatedEuler = GetAsEuler_XFwd_YLeft_ZUp( xEast, yNorth );
	return rotatedEuler;
}
...
//----------------------------------------------------------------------------------------------------------------------
// TurnRate is specified as "degrees per second"
//----------------------------------------------------------------------------------------------------------------------
void EulerAngles::TurnTowardGoal( EulerAngles const& eulerAnglesGoal, float deltaSeconds, float turnRateYaw, float turnRatePitch, float turnRateRoll )
{
	...
	m_yawDegrees	= MoveTowardGoal( m_yawDegrees,	  eulerAnglesGoal.m_yawDegrees,	  maxYawThisFrame );
	m_pitchDegrees	= MoveTowardGoal( m_pitchDegrees, eulerAnglesGoal.m_pitchDegrees, maxPitchThisFrame );
	m_rollDegrees	= MoveTowardGoal( m_rollDegrees,  eulerAnglesGoal.m_rollDegrees,  maxRollThisFrame );
}
