...
public:
	...
	static Vec2 const MakeFromPolarDegrees_Skewed( float orientationDegrees, float length = 1.0f, Vec2 startRadiusScalarXY = Vec2( 1.0f, 1.0f ) );
	static Vec2 const MakeFromPolarRadians_Skewed( float orientationRadians, float length = 1.0f, Vec2 startRadiusScalarXY = Vec2( 1.0f, 1.0f ) );
