...
public:
	...
	// Static Methods
	static Vec3 const MakeFromSphericalRadians( float yawRadians, float pitchRadians, float length = 1.0f, Vec2 const& startRadiusScalarXY = Vec2(1.0f, 1.0f) );
	static Vec3 const MakeFromSphericalDegrees( float yawDegrees, float pitchDegrees, float length = 1.0f, Vec2 const& startRadiusScalarXY = Vec2(1.0f, 1.0f) );
